...
export default function StudyToolPitchRegisterPage() {
            ...
            <section className="flex flex-1 items-center justify-center px-4 py-16">
                <div className="w-full max-w-xl">
                    <div className="mb-8 border-l-2 border-blue-500 pl-6">
                        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-500 mb-2">Event Enrollment</p>
                        <h1 className="text-4xl font-bold tracking-tighter text-white">
                            Study Tool <span className="text-blue-500">Pitch</span>
                        </h1>
                        <p className="mt-2 text-sm text-cool-steel-400">March 20, 2026 &bull; Beginner Friendly</p>
                    </div>
                    ...
                    <div className="rounded-sm bg-neutral-900/70 shadow-sm shadow-black/40">
                        {submitted ? (
                            <div className="text-center py-12 px-6">
                                ...
                                <p className="text-cool-steel-400 text-sm mb-6">We'll see you March 20 at 6:00 PM. Start thinking about your pitch!</p>
                                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                                    <Link href="/events/study-tool-pitch" className="rounded-full bg-neutral-800 px-6 py-2.5 text-sm font-semibold text-cool-steel-200 hover:bg-neutral-700 transition">
                                        Event Page
                                    </Link>
                            ...
                            <form onSubmit={handleAlreadyLoggedIn} className="p-6 space-y-4">
                                ...
                                {user.registeredEventIds?.includes(EVENT_ID) ? (
                                    <div className="text-center py-4">
                                        <p className="text-blue-400 font-semibold text-sm">You're already registered for this event.</p>
                                        <Link href="/events/study-tool-pitch" className="mt-4 inline-block text-xs text-cool-steel-400 hover:text-white underline">
                                            Go to event page
                                        </Link>
                                    </div>
                                ) : (
                                ...
                                {mode === "register" && (
                                    <form onSubmit={handleRegister} className="p-6 space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <textarea value={bio} onChange={e => setBio(e.target.value)} rows={2} className={inputClass} placeholder="Tell us about yourself and what you plan to pitch." />
                                        </div>
                                            ...
                                            <div className="flex items-center justify-between gap-4">
                                                <div>
                                                    ...
                                                    <p className="mt-0.5 text-xs text-cool-steel-400">
                                                        ...
                                                        <Link href="/terms" target="_blank" className="text-blue-400 hover:underline">Terms</Link>
                                                    </p>
                                                </div>
